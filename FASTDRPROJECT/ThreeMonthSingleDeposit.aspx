<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ThreeMonthSingleDeposit.aspx.cs" Inherits="FASTDRPROJECT.ThreeMonthSingleDeposit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center">
        <strong><asp:Label ID="lblScheme" runat="server" Text="Three Month Scheme"></asp:Label></strong>
    </div>
    <div align="center">
