<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SingleDeposit.aspx.cs" Inherits="FASTDRPROJECT.FFIL_Semi_Annual_Profit_Scheme.SingleDeposit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center">
        <strong><asp:Label ID="lblScheme" runat="server" Text="Semi Annual Profit Scheme"></asp:Label></strong>
    </div>
    <div align="center">
