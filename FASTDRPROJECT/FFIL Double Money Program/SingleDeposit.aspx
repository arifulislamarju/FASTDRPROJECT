<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SingleDeposit.aspx.cs" Inherits="FASTDRPROJECT.FFIL_Double_Money_Program.SingleDeposit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center">
        <strong><asp:Label ID="lblScheme" runat="server" Text="Double Money Program"></asp:Label></strong>
    </div>
    <div align="center">
